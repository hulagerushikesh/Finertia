...
- [x] Regime-aware walk-forward — anchored rolling folds + realised-vol regime label, both 16 Sep (`rolling.py`, `regimes.py`, §3). Trend label beside vol added 21 Sep (`label_trend`, ±1σ t-stat, vol × trend grid; DECISIONS 21 Sep) — not yet on the regime table in the UI
