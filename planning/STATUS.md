...
_Current to `e2970ca` (main) · 16 Sep 2026._

## At a glance

| | |
|---|---|
| Live | https://finertia.hulage.in — Vercel (frontend) + Cloud Run `finertia-api` asia-south1 rev `00006` (16 Sep: rolling walk-forward) |
...
| Commits | 40 on main · 9 PRs merged |
| API | 16 routes |
...
| 16 Sep | Volatility regimes (`regimes.py`): per-bar realised-vol terciles, Sharpe per regime on every backtest + the stitched OOS record | 14 + 2 tests, 603 total; 2 mutation checks; momentum OOS 2.26 calm / −0.76 turbulent |
