...
| [03-validation-methods.md](03-validation-methods.md) | What Finertia does that most backtesters do not: walk-forward, permutation, DSR, PBO, purging, bootstrap CIs — with formulas, traps, and where each lives | Advanced | ~40h |
